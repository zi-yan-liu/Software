...
# this script is for the case that all watchtowers are connected
# under the same master, usually the laptop.
...
### ------------------ INITIALIZATION FUNCTIONS -------------------------#####
    ...
    def add_subscribers(self):
        ...
        for watchtower in self.watchtowers:
            self.poses_subscribers.append(rospy.Subscriber("/"+watchtower+"/apriltags2_local_localization_node/apriltags_out", RemapPoseArray, self.local_poses_callback, queue_size=1))
    ...
    def load_map_info(self):
        ...
        self.watchtowers = map_data['watchtowers']
